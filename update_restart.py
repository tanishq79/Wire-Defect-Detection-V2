"""Apply a SurfaceAI update after stopping the active server safely."""
...
def main() -> None:
    ...
    # Let the API return its response before terminating the server process.
    time.sleep(1.5)
    ...
    # Restart even after an update failure so the station is not left offline.
